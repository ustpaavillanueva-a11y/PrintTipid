...
import { Payment, Order } from '@/app/models';
                ...
                <p-table [value]="paymentHistory" [rows]="10" [paginator]="true" responsiveLayout="scroll" [globalFilterFields]="['referenceNo']">
                    ...
                    <ng-template pTemplate="body" let-payment>
                        <tr>
                            ...
                            <td>
                                <p-button icon="pi pi-eye" [rounded]="true" [text]="true" (click)="viewPaymentDetails(payment)" pTooltip="View Details" tooltipPosition="top"></p-button>
                            </td>
                        </tr>
                    </ng-template>
